...
/**
 * Jersey REST client generated for REST resource:ProgressFacadeREST
 * [progress]<br>
 *  USAGE:
 * <pre>
 *        WSProgressHelper client = new WSProgressHelper();
...
public class WSProgressHelper {
    ...
    public WSProgressHelper() {
        ...
        webResource = client.resource(BASE_URI).path("progress");
    }

    public <T> T findProgressByProjectIdWebsite(Class<T> responseType, String id) throws UniformInterfaceException {
    ...
    public <T> T findProgressByTaskIdWebsite(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
    ...
    public <T> T createNewProgress(Class<T> responseType, Object requestEntity) throws UniformInterfaceException {
