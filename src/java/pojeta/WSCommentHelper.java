 ...
 *  USAGE:
 * <pre>
 *        WSCommentHelper client = new WSCommentHelper();
...
public class WSCommentHelper {
    ...
    public String findByTaskId(String id) throws UniformInterfaceException {
        WebResource resource = webResource;
